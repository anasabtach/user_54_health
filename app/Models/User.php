...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'user_group_id','user_type','name','business_name','category_id','username','slug',
        'work_email','email','mobile_no','password','image_url','blur_image','id_card','profession',
        'status','country', 'city', 'state','zipcode','address','latitude','longitude',
        'open_time','close_time','about','is_email_verify','email_verify_at','is_mobile_verify',
    ...
    {
        return $this->belongsTo(Country::class,'county','id');
    }
    ...
    {
        $user = self::with(['category','country','state','city'])
                    ->select('users.*')
